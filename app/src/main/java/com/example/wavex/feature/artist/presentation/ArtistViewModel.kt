...
import com.example.wavex.feature.artist.data.ArtistRepository
...
class ArtistViewModel @Inject constructor(
    ...
    fun checkFavouriteArtist(artistId: String) {
        viewModelScope.launch {

            _isFavourite.value =
                repository.isFavouriteArtist(
                    artistId
                )
        }
    }

    fun toggleFavouriteArtist(
        artistId: String,
        artistName: String,
        ...
        viewModelScope.launch {
            try {
                val (isFavourite, message) =
                    repository.toggleFavouriteArtist(
                        artistId = artistId,
